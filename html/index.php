...
if(WebP.height!=2){var sc=document.createElement('script');sc.type='text/javascript';sc.async=false;
...
<script>
if (screen && screen.width >= 341) {
  document.write('<script src="js\/scripts341.js"><\/script>');
} else {
  document.write('<script src="js\/scripts320.js"><\/script>');
};
</script>
